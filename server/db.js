...
const pool = new Pool({
  ...
  database: "", // name of db you wanna connect with, in my case it was test cause i called it that
  password: "", //im not giving you my password, will be an env when pushed to GH
  port: 5432 // generic port for pg
});
module.exports = pool;
// put in your own port and password and database
